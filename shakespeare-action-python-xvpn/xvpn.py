...
APP_DESCRIPTION = '离线模拟 VPN 远程接入系统，支持登录状态、账号创建、账号禁用和踢人下线'
DEFAULT_RECORDS = json.loads('[\n  {\n    "id": "vpn-user-alice",\n    "type": "vpn_account",\n    "name": "alice",\n    "owner": "电商业务部",\n    "user": "alice",\n    "status": "enabled",\n    "severity": "medium",\n    "summary": "alice VPN 账号已启用，最近从异常公网 IP 登录",\n    "metadata": {\n      "mfa": true,\n      "groups": [\n        "vpn-users"\n      ],\n      "last_login_ip": "203.0.113.77",\n      "last_login_time": "2026-07-09 09:18:24"\n    }\n  },\n  {\n    "id": "vpn-session-alice-001",\n    "type": "vpn_session",\n    "name": "alice active vpn session",\n    "owner": "alice",\n    "user": "alice",\n    "status": "online",\n    "severity": "high",\n    "ip": "10.60.8.11",\n    "summary": "alice 当前 VPN 在线，会话源 IP 命中威胁情报",\n    "metadata": {\n      "session_id": "vpn-sess-0001",\n      "source_ip": "203.0.113.77",\n      "client": "macOS",\n      "login_time": "2026-07-09 10:02:15"\n    }\n  },\n  {\n    "id": "vpn-user-carol",\n    "type": "vpn_account",\n    "name": "carol",\n    "owner": "财务部",\n    "user": "carol",\n    "status": "enabled",\n    "severity": "medium",\n    "summary": "carol VPN 账号已启用",\n    "metadata": {\n      "mfa": false,\n      "groups": [\n        "vpn-users"\n      ],\n      "last_login_ip": "198.51.100.23"\n    }\n  }\n]')
ACTION_DEFINITIONS = json.loads('[\n  {\n    "action": "health_check",\n    "description": "健康检查",\n    "classify": "query",\n    "operation": "health",\n    "parameters": {},\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  },\n  {\n    "action": "query_login_status",\n    "description": "查询 VPN 用户登录状态",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": false,\n        "order": 0\n      },\n      "status": {\n        "data_type": "string",\n        "description": "状态",\n        "required": false,\n        "order": 1\n      }\n    },\n    "filter_keys": [\n      "user",\n      "name",\n      "status"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "alice"\n    }\n  },\n  {\n    "action": "query_online_users",\n    "description": "查询 VPN 在线用户",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": false,\n        "order": 0\n      },\n      "status": {\n        "data_type": "string",\n        "description": "登录状态",\n        "required": false,\n        "order": 1,\n        "default_value": "online"\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回数量",\n        "required": false,\n        "order": 2,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "user",\n      "status"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "alice"\n    }\n  },\n  {\n    "action": "create_vpn_account",\n    "description": "创建 VPN 账号",\n    "classify": "write",\n    "operation": "create",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": true,\n        "order": 0\n      },\n      "display_name": {\n        "data_type": "string",\n        "description": "显示名",\n        "required": false,\n        "order": 1,\n        "default_value": ""\n      },\n      "department": {\n        "data_type": "string",\n        "description": "部门",\n        "required": false,\n        "order": 2,\n        "default_value": "未分配"\n      }\n    },\n    "filter_keys": [],\n    "result_status": "enabled",\n    "allow_create": false,\n    "sample": {\n      "username": "dave",\n      "display_name": "Dave",\n      "department": "安全运营"\n    }\n  },\n  {\n    "action": "disable_vpn_account",\n    "description": "禁用 VPN 账号",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": true,\n        "order": 0\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "禁用原因",\n        "required": false,\n        "order": 1,\n        "default_value": "安全事件处置"\n      }\n    },\n    "filter_keys": [\n      "name",\n      "user",\n      "username"\n    ],\n    "result_status": "disabled",\n    "allow_create": false,\n    "sample": {\n      "username": "alice",\n      "reason": "疑似账号失陷"\n    }\n  },\n  {\n    "action": "enable_vpn_account",\n    "description": "启用 VPN 账号",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": true,\n        "order": 0\n      }\n    },\n    "filter_keys": [\n      "name",\n      "user",\n      "username"\n    ],\n    "result_status": "enabled",\n    "allow_create": false,\n    "sample": {\n      "username": "alice"\n    }\n  },\n  {\n    "action": "kick_vpn_user",\n    "description": "踢 VPN 用户下线",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": true,\n        "order": 0\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "踢下线原因",\n        "required": false,\n        "order": 1,\n        "default_value": "安全处置"\n      }\n    },\n    "filter_keys": [\n      "user",\n      "name",\n      "username"\n    ],\n    "result_status": "offline",\n    "allow_create": false,\n    "sample": {\n      "username": "alice",\n      "reason": "异常公网 IP 登录"\n    }\n  },\n  {\n    "action": "query_vpn_history",\n    "description": "查询 VPN 登录历史",\n    "classify": "query",\n    "operation": "history",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "用户名",\n        "required": false,\n        "order": 0\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回数量",\n        "required": false,\n        "order": 1,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "username"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "alice"\n    }\n  }\n]')
...
def query_login_status(params, assets, context_info):
    """查询 VPN 用户登录状态"""
    return _execute('query_login_status', params, assets, context_info)


def query_online_users(params, assets, context_info):
    """查询 VPN 在线用户"""
    return _execute('query_online_users', params, assets, context_info)


def create_vpn_account(params, assets, context_info):
    """创建 VPN 账号"""
    return _execute('create_vpn_account', params, assets, context_info)


def disable_vpn_account(params, assets, context_info):
    """禁用 VPN 账号"""
    return _execute('disable_vpn_account', params, assets, context_info)


def enable_vpn_account(params, assets, context_info):
    """启用 VPN 账号"""
    return _execute('enable_vpn_account', params, assets, context_info)


def kick_vpn_user(params, assets, context_info):
    """踢 VPN 用户下线"""
    return _execute('kick_vpn_user', params, assets, context_info)


def query_vpn_history(params, assets, context_info):
    """查询 VPN 登录历史"""
    return _execute('query_vpn_history', params, assets, context_info)
