...
APP_NAME = 'tencent_asset_sim'
PRODUCT_NAME = '腾讯云资产中心（模拟）'
APP_DESCRIPTION = '离线模拟腾讯云主机、业务系统、负责人、VPC 和互联网暴露面资产上下文'
APP_VERSION = '1.0.0'
DEFAULT_RECORDS = json.loads('[{"id": "asset-cvm-prod-web-01", "kind": "cloud_asset", "name": "prod-web-01", "ip": "10.10.8.23", "owner": "alice", "status": "online", "severity": "critical", "summary": "统一收银台公网 Web 主机，关联 WAF 域名并暴露 80/443", "data": {"asset_id": "asset-cvm-prod-web-01", "host_id": "ins-prod-web-01", "asset_type": "cvm", "business_id": "biz-checkout", "business_name": "统一收银台", "department": "支付业务部", "owner_account": "alice", "owner_name": "张敏", "owner_email": "alice@example.com", "is_critical": true, "exposure": "internet", "public_ip": "198.18.0.23", "domains": ["checkout.example.com"], "open_ports": [80, 443], "vpc_id": "vpc-web-prod", "region": "ap-guangzhou"}}, {"id": "asset-cvm-order-db-01", "kind": "cloud_asset", "name": "order-db-01", "ip": "10.10.9.15", "owner": "bob", "status": "online", "severity": "critical", "summary": "订单核心数据库，仅允许业务 VPC 按白名单访问", "data": {"asset_id": "asset-cvm-order-db-01", "host_id": "ins-order-db-01", "asset_type": "cvm", "business_id": "biz-order", "business_name": "订单中心", "department": "平台工程部", "owner_account": "bob", "owner_name": "李伟", "owner_email": "bob@example.com", "is_critical": true, "exposure": "private", "public_ip": "", "domains": [], "open_ports": [3306], "vpc_id": "vpc-data-prod", "region": "ap-guangzhou"}}, {"id": "asset-clb-checkout-01", "kind": "cloud_asset", "name": "checkout-clb-01", "ip": "10.10.8.10", "owner": "alice", "status": "online", "severity": "high", "summary": "统一收银台公网负载均衡，前置腾讯云 WAF", "data": {"asset_id": "asset-clb-checkout-01", "asset_type": "clb", "business_id": "biz-checkout", "business_name": "统一收银台", "department": "支付业务部", "owner_account": "alice", "owner_name": "张敏", "owner_email": "alice@example.com", "is_critical": true, "exposure": "internet", "public_ip": "198.18.0.10", "domains": ["checkout.example.com"], "open_ports": [443], "vpc_id": "vpc-web-prod", "region": "ap-guangzhou"}}, {"id": "asset-tke-prod-checkout", "kind": "cloud_asset", "name": "prod-checkout-tke", "ip": "10.30.0.10", "owner": "platform-team", "status": "online", "severity": "high", "summary": "统一收银台生产 TKE 集群，启用容器安全运行时防护", "data": {"asset_id": "asset-tke-prod-checkout", "cluster_id": "cls-prod-checkout", "asset_type": "tke_cluster", "business_id": "biz-checkout", "business_name": "统一收银台", "department": "平台工程部", "owner_account": "platform-team", "owner_name": "平台团队", "owner_email": "platform@example.com", "is_critical": true, "exposure": "private", "public_ip": "", "domains": [], "open_ports": [6443], "vpc_id": "vpc-container-prod", "region": "ap-guangzhou"}}]')
ACTION_DEFINITIONS = json.loads('[{"action": "health_check", "description": "检查模拟 API、鉴权和组件状态", "operation": "health", "classify": "query", "parameters": {}, "sample": {}, "record_kinds": [], "filter_map": {}, "target_params": []}, {"action": "list_assets", "description": "查询云资产列表", "operation": "query", "classify": "query", "parameters": {"asset_type": {"data_type": "string", "description": "资产类型", "required": false, "order": 0}, "owner": {"data_type": "string", "description": "负责人账号；样例 alice、bob、platform-team", "required": false, "order": 1}, "status": {"data_type": "string", "description": "资产状态", "required": false, "order": 2}, "business_id": {"data_type": "string", "description": "业务系统 ID", "required": false, "order": 3}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 4, "default_value": 50}}, "sample": {"owner": "alice", "limit": 20}, "record_kinds": ["cloud_asset"], "filter_map": {"asset_type": ["asset_type"], "owner": ["owner", "owner_account"], "status": ["status"], "business_id": ["business_id"]}, "target_params": []}, {"action": "query_asset_by_ip", "description": "根据 IP 查询主机、业务、负责人和暴露面", "operation": "query", "classify": "query", "parameters": {"ip": {"data_type": "string", "description": "内网或公网 IP", "required": true, "order": 0}}, "sample": {"ip": "10.10.8.23"}, "record_kinds": ["cloud_asset"], "filter_map": {"ip": ["ip", "public_ip"]}, "target_params": []}, {"action": "query_asset_by_id", "description": "根据资产 ID 查询资产上下文", "operation": "query", "classify": "query", "parameters": {"asset_id": {"data_type": "string", "description": "资产 ID", "required": true, "order": 0}}, "sample": {"asset_id": "asset-cvm-prod-web-01"}, "record_kinds": ["cloud_asset"], "filter_map": {"asset_id": ["id", "asset_id"]}, "target_params": []}, {"action": "query_assets_by_owner", "description": "根据负责人账号查询名下资产", "operation": "query", "classify": "query", "parameters": {"owner": {"data_type": "string", "description": "负责人账号；样例 alice、bob、platform-team", "required": true, "order": 0}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 1, "default_value": 50}}, "sample": {"owner": "alice"}, "record_kinds": ["cloud_asset"], "filter_map": {"owner": ["owner", "owner_account"]}, "target_params": []}, {"action": "list_exposed_assets", "description": "查询互联网暴露资产", "operation": "query", "classify": "query", "parameters": {"exposure": {"data_type": "string", "description": "暴露类型", "required": false, "order": 0, "default_value": "internet"}, "business_id": {"data_type": "string", "description": "业务系统 ID", "required": false, "order": 1}, "owner": {"data_type": "string", "description": "负责人账号", "required": false, "order": 2}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 3, "default_value": 50}}, "sample": {"exposure": "internet"}, "record_kinds": ["cloud_asset"], "filter_map": {"exposure": ["exposure"], "business_id": ["business_id"], "owner": ["owner", "owner_account"]}, "target_params": []}, {"action": "query_business_context", "description": "查询业务系统关联资产与负责人", "operation": "query", "classify": "query", "parameters": {"business_id": {"data_type": "string", "description": "业务系统 ID", "required": true, "order": 0}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 1, "default_value": 50}}, "sample": {"business_id": "biz-checkout"}, "record_kinds": ["cloud_asset"], "filter_map": {"business_id": ["business_id"]}, "target_params": []}, {"action": "create_asset", "description": "新增模拟云资产", "operation": "create_record", "classify": "write", "parameters": {"asset_id": {"data_type": "string", "description": "资产 ID；不填则自动生成", "required": false, "order": 0}, "asset_name": {"data_type": "string", "description": "资产名称", "required": true, "order": 1}, "ip": {"data_type": "string", "description": "资产内网 IP", "required": true, "order": 2}, "asset_type": {"data_type": "string", "description": "资产类型", "required": false, "order": 3, "default_value": "cvm"}, "owner": {"data_type": "string", "description": "负责人账号", "required": false, "order": 4, "default_value": "secops"}, "business_id": {"data_type": "string", "description": "业务系统 ID", "required": false, "order": 5, "default_value": "biz-demo"}, "business_name": {"data_type": "string", "description": "业务系统名称", "required": false, "order": 6, "default_value": "演示业务"}, "exposure": {"data_type": "string", "description": "暴露类型", "required": false, "order": 7, "default_value": "private"}, "severity": {"data_type": "string", "description": "资产等级", "required": false, "order": 8, "default_value": "medium"}, "summary": {"data_type": "string", "description": "资产说明", "required": false, "order": 9, "default_value": "手工新增模拟云资产"}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 20, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 21, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 22, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 23}}, "sample": {"asset_id": "asset-cvm-demo-01", "asset_name": "demo-api-01", "ip": "10.40.8.21", "asset_type": "cvm", "owner": "secops", "business_id": "biz-demo", "business_name": "演示业务", "exposure": "private", "trace_id": "demo-trace-asset-crud"}, "record_kinds": [], "filter_map": {}, "target_params": [], "result_status": "online", "id_param": "asset_id", "create_kind": "cloud_asset"}, {"action": "update_asset", "description": "更新模拟云资产信息", "operation": "update_record", "classify": "write", "parameters": {"asset_id": {"data_type": "string", "description": "资产 ID", "required": true, "order": 0}, "asset_name": {"data_type": "string", "description": "资产名称", "required": false, "order": 1}, "owner": {"data_type": "string", "description": "负责人账号", "required": false, "order": 2}, "business_id": {"data_type": "string", "description": "业务系统 ID", "required": false, "order": 3}, "business_name": {"data_type": "string", "description": "业务系统名称", "required": false, "order": 4}, "exposure": {"data_type": "string", "description": "暴露类型", "required": false, "order": 5}, "status": {"data_type": "string", "description": "资产状态", "required": false, "order": 6}, "severity": {"data_type": "string", "description": "资产等级", "required": false, "order": 7}, "summary": {"data_type": "string", "description": "资产说明", "required": false, "order": 8}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 20, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 21, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 22, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 23}}, "sample": {"asset_id": "asset-cvm-prod-web-01", "owner": "alice", "exposure": "internet", "status": "online", "trace_id": "demo-trace-asset-update"}, "record_kinds": ["cloud_asset"], "filter_map": {"asset_id": ["id", "asset_id"]}, "target_params": ["asset_id"]}, {"action": "delete_asset", "description": "删除模拟云资产", "operation": "delete_record", "classify": "write", "parameters": {"asset_id": {"data_type": "string", "description": "资产 ID", "required": true, "order": 0}, "reason": {"data_type": "string", "description": "删除原因", "required": false, "order": 1, "default_value": "资产下线"}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 10, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 11, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 12, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 13}}, "sample": {"asset_id": "asset-cvm-demo-01", "reason": "演示资产下线", "trace_id": "demo-trace-asset-crud"}, "record_kinds": ["cloud_asset"], "filter_map": {"asset_id": ["id", "asset_id"]}, "target_params": ["asset_id"]}, {"action": "query_operation_history", "description": "查询产品模拟操作审计记录", "operation": "history", "classify": "query", "parameters": {"trace_id": {"data_type": "string", "description": "按 trace_id 过滤", "required": false, "order": 0}, "target": {"data_type": "string", "description": "按目标 IP、资产或策略 ID 过滤", "required": false, "order": 1}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 2, "default_value": 50}}, "sample": {"trace_id": "demo-trace-web-0001", "limit": 20}, "record_kinds": [], "filter_map": {}, "target_params": []}]')
HEALTH_COMPONENTS = json.loads('["云资产同步", "负责人映射", "业务关系索引", "暴露面索引"]')
...
def list_assets(params, assets, context_info):
    """查询云资产列表"""
    return _execute('list_assets', params, assets, context_info)


def query_asset_by_ip(params, assets, context_info):
    """根据 IP 查询主机、业务、负责人和暴露面"""
    return _execute('query_asset_by_ip', params, assets, context_info)


def query_asset_by_id(params, assets, context_info):
    """根据资产 ID 查询资产上下文"""
    return _execute('query_asset_by_id', params, assets, context_info)


def query_assets_by_owner(params, assets, context_info):
    """根据负责人账号查询名下资产"""
    return _execute('query_assets_by_owner', params, assets, context_info)


def list_exposed_assets(params, assets, context_info):
    """查询互联网暴露资产"""
    return _execute('list_exposed_assets', params, assets, context_info)


def query_business_context(params, assets, context_info):
    """查询业务系统关联资产与负责人"""
    return _execute('query_business_context', params, assets, context_info)


def create_asset(params, assets, context_info):
    """新增模拟云资产"""
    return _execute('create_asset', params, assets, context_info)


def update_asset(params, assets, context_info):
    """更新模拟云资产信息"""
    return _execute('update_asset', params, assets, context_info)


def delete_asset(params, assets, context_info):
    """删除模拟云资产"""
    return _execute('delete_asset', params, assets, context_info)
