...
def send_message(params, assets, context_info):
    """发送企业微信式消息"""
    return _execute('send_message', params, assets, context_info)


def send_email(params, assets, context_info):
    """发送邮件式通知"""
    return _execute('send_email', params, assets, context_info)


def send_sms(params, assets, context_info):
    """发送短信式通知"""
    return _execute('send_sms', params, assets, context_info)


def query_notification_history(params, assets, context_info):
    """查询通知历史"""
    return _execute('query_notification_history', params, assets, context_info)


def query_delivery_status(params, assets, context_info):
    """查询投递状态"""
    return _execute('query_delivery_status', params, assets, context_info)


def register_channel(params, assets, context_info):
    """注册通知通道"""
    return _execute('register_channel', params, assets, context_info)
