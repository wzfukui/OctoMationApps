...
def query_protected_sites(params, assets, context_info):
    """查询受保护站点"""
    return _execute('query_protected_sites', params, assets, context_info)
...
def add_url_rule(params, assets, context_info):
    """新增 URL 防护规则"""
    return _execute('add_url_rule', params, assets, context_info)
