...
def query_ip_reputation(params, assets, context_info):
    """查询 IP 信誉"""
    return _execute('query_ip_reputation', params, assets, context_info)


def query_domain_reputation(params, assets, context_info):
    """查询域名信誉"""
    return _execute('query_domain_reputation', params, assets, context_info)


def query_url_reputation(params, assets, context_info):
    """查询 URL 信誉"""
    return _execute('query_url_reputation', params, assets, context_info)


def query_file_reputation(params, assets, context_info):
    """查询文件 Hash 信誉"""
    return _execute('query_file_reputation', params, assets, context_info)


def query_cve_intel(params, assets, context_info):
    """查询漏洞情报"""
    return _execute('query_cve_intel', params, assets, context_info)


def submit_indicator(params, assets, context_info):
    """提交自定义情报指标"""
    return _execute('submit_indicator', params, assets, context_info)
