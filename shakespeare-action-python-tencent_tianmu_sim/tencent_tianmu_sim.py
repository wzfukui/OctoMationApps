...
APP_NAME = 'tencent_tianmu_sim'
PRODUCT_NAME = '腾讯天幕 NIPS（模拟）'
APP_DESCRIPTION = '离线模拟腾讯天幕旁路阻断、解封、策略查询、TTL 到期和审计能力'
APP_VERSION = '1.0.0'
DEFAULT_RECORDS = json.loads('[{"id": "tm-pol-demo-0001", "kind": "tianmu_block_policy", "name": "SQL 注入攻击源旁路阻断", "ip": "203.0.113.77", "owner": "soar-demo", "status": "active", "severity": "high", "summary": "由 SOC 高危 Web 攻击告警触发的 4 层旁路阻断策略", "data": {"policy_id": "tm-pol-demo-0001", "trace_id": "demo-trace-web-0001", "operator": "soar-demo", "trigger_source": "soc_alert", "ttl_minutes": 60, "created_at": "2026-07-24T09:34:00+08:00", "expires_at": "2099-07-24T10:34:00+08:00", "scope": "global", "direction": "bidirectional", "alert_id": "soc-alert-20260724-0001"}}, {"id": "tm-pol-demo-0002", "kind": "tianmu_block_policy", "name": "历史恶意扫描源阻断", "ip": "192.0.2.44", "owner": "soar-demo", "status": "released", "severity": "medium", "summary": "TTL 到期后已自动解封的历史策略", "data": {"policy_id": "tm-pol-demo-0002", "trace_id": "demo-trace-web-0001", "operator": "soar-demo", "trigger_source": "soc_alert", "ttl_minutes": 30, "created_at": "2026-07-24T08:00:00+08:00", "expires_at": "2026-07-24T08:30:00+08:00", "released_at": "2026-07-24T08:30:03+08:00", "scope": "global"}}]')
ACTION_DEFINITIONS = json.loads('[{"action": "health_check", "description": "检查模拟 API、鉴权和组件状态", "operation": "health", "classify": "query", "parameters": {}, "sample": {}, "record_kinds": [], "filter_map": {}, "target_params": []}, {"action": "list_block_policies", "description": "查询旁路阻断策略", "operation": "query", "classify": "query", "parameters": {"policy_id": {"data_type": "string", "description": "策略 ID", "required": false, "order": 0}, "ip": {"data_type": "string", "description": "封禁 IP", "required": false, "order": 1}, "status": {"data_type": "string", "description": "策略状态", "required": false, "order": 2}, "trace_id": {"data_type": "string", "description": "SOAR trace_id", "required": false, "order": 3}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 4, "default_value": 50}}, "sample": {"ip": "203.0.113.77"}, "record_kinds": ["tianmu_block_policy"], "filter_map": {"policy_id": ["id", "policy_id"], "ip": ["ip"], "status": ["status"], "trace_id": ["trace_id"]}, "target_params": []}, {"action": "block_ip", "description": "创建天幕旁路 IP 阻断策略", "operation": "create_policy", "classify": "write", "parameters": {"ip": {"data_type": "string", "description": "需要封禁的 IP", "required": true, "order": 0}, "reason": {"data_type": "string", "description": "封禁原因", "required": false, "order": 1, "default_value": "SOAR 高危告警联动"}, "ttl_minutes": {"data_type": "integer", "description": "封禁时长（分钟），0 表示永久", "required": false, "order": 2, "default_value": 60}, "scope": {"data_type": "string", "description": "阻断范围", "required": false, "order": 3, "default_value": "global"}, "direction": {"data_type": "string", "description": "阻断方向", "required": false, "order": 4, "default_value": "bidirectional"}, "alert_id": {"data_type": "string", "description": "关联 SOC 告警 ID", "required": false, "order": 5}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 10, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 11, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 12, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 13}}, "sample": {"ip": "198.51.100.66", "reason": "反弹 Shell 外联 C2", "ttl_minutes": 120, "scope": "global", "direction": "bidirectional", "alert_id": "soc-alert-20260724-0002", "trace_id": "demo-trace-reverse-shell-0002"}, "record_kinds": [], "filter_map": {}, "target_params": ["ip"], "result_status": "active", "policy_kind": "tianmu_block_policy", "policy_prefix": "tm-pol"}, {"action": "unblock_ip", "description": "解除天幕旁路 IP 阻断", "operation": "release_policy", "classify": "write", "parameters": {"policy_id": {"data_type": "string", "description": "策略 ID；与目标至少填写一项", "required": false, "order": 0}, "ip": {"data_type": "string", "description": "需要解封的 IP；与策略 ID 至少填写一项", "required": false, "order": 1}, "reason": {"data_type": "string", "description": "解封原因", "required": false, "order": 2, "default_value": "TTL 到期或人工复核"}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 10, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 11, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 12, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 13}}, "sample": {"policy_id": "tm-pol-demo-0001", "ip": "203.0.113.77", "reason": "人工复核后解除", "trace_id": "demo-trace-web-0001"}, "record_kinds": [], "filter_map": {}, "target_params": ["policy_id", "ip"], "result_status": "released", "policy_kind": "tianmu_block_policy"}, {"action": "expire_due_policies", "description": "扫描并自动释放已到期策略", "operation": "expire_policies", "classify": "write", "parameters": {"as_of": {"data_type": "string", "description": "到期判断时间，ISO 8601；默认当前时间", "required": false, "order": 0}, "trace_id": {"data_type": "string", "description": "SOAR 链路追踪 ID", "required": false, "order": 10, "default_value": "demo-trace-web-0001"}, "operator": {"data_type": "string", "description": "操作者账号", "required": false, "order": 11, "default_value": "soar-demo"}, "trigger_source": {"data_type": "string", "description": "触发来源，例如 soc_alert、manual、scheduled", "required": false, "order": 12, "default_value": "soc_alert"}, "approval_id": {"data_type": "string", "description": "审批单 ID；需要审批时由剧本传入", "required": false, "order": 13}}, "sample": {"as_of": "2100-01-01T00:00:00+08:00", "trigger_source": "scheduled", "trace_id": "demo-trace-ttl-tianmu"}, "record_kinds": [], "filter_map": {}, "target_params": [], "result_status": "expired", "policy_kind": "tianmu_block_policy"}, {"action": "query_operation_history", "description": "查询产品模拟操作审计记录", "operation": "history", "classify": "query", "parameters": {"trace_id": {"data_type": "string", "description": "按 trace_id 过滤", "required": false, "order": 0}, "target": {"data_type": "string", "description": "按目标 IP、资产或策略 ID 过滤", "required": false, "order": 1}, "limit": {"data_type": "integer", "description": "返回数量", "required": false, "order": 2, "default_value": 50}}, "sample": {"trace_id": "demo-trace-web-0001", "limit": 20}, "record_kinds": [], "filter_map": {}, "target_params": []}]')
HEALTH_COMPONENTS = json.loads('["旁路阻断 API", "解封 API", "策略同步引擎", "流量探针"]')
...
def list_block_policies(params, assets, context_info):
    """查询旁路阻断策略"""
    return _execute('list_block_policies', params, assets, context_info)


def block_ip(params, assets, context_info):
    """创建天幕旁路 IP 阻断策略"""
    return _execute('block_ip', params, assets, context_info)


def unblock_ip(params, assets, context_info):
    """解除天幕旁路 IP 阻断"""
    return _execute('unblock_ip', params, assets, context_info)
