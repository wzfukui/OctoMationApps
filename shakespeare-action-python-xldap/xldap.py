...
APP_DESCRIPTION = '离线模拟 LDAP/AD 目录服务，支持用户、组织、用户组和账号状态管理'
...
def query_group(params, assets, context_info):
    """查询 LDAP 用户组信息"""
    return _execute('query_group', params, assets, context_info)


def query_user_groups(params, assets, context_info):
    """查询用户所属组"""
    return _execute('query_user_groups', params, assets, context_info)


def create_user(params, assets, context_info):
    """创建 LDAP 用户"""
    return _execute('create_user', params, assets, context_info)
...
def add_user_to_group(params, assets, context_info):
    """将用户加入用户组"""
    return _execute('add_user_to_group', params, assets, context_info)
