...
def query_mac_table(params, assets, context_info):
    """查询 MAC 地址表"""
    return _execute('query_mac_table', params, assets, context_info)


def query_arp_table(params, assets, context_info):
    """查询 ARP 表"""
    return _execute('query_arp_table', params, assets, context_info)


def query_interface_status(params, assets, context_info):
    """查询接口状态"""
    return _execute('query_interface_status', params, assets, context_info)


def disable_port(params, assets, context_info):
    """关闭交换机端口"""
    return _execute('disable_port', params, assets, context_info)


def enable_port(params, assets, context_info):
    """恢复交换机端口"""
    return _execute('enable_port', params, assets, context_info)
