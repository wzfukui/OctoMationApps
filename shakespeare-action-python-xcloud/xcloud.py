...
APP_DESCRIPTION = '离线模拟云资产和安全组处置能力，支持云资产、安全组、封禁和快照'
DEFAULT_RECORDS = json.loads('[\n  {\n    "id": "ecs-prod-web-01",\n    "type": "cloud_instance",\n    "name": "prod-web-01",\n    "ip": "10.10.8.23",\n    "owner": "alice",\n    "status": "running",\n    "severity": "high",\n    "summary": "云上 Web 服务器，绑定 sg-dmz-web",\n    "metadata": {\n      "region": "cn-example-1",\n      "security_group": "sg-dmz-web",\n      "instance_type": "c8.large"\n    }\n  },\n  {\n    "id": "sg-dmz-web",\n    "type": "security_group",\n    "name": "sg-dmz-web",\n    "status": "active",\n    "severity": "medium",\n    "summary": "DMZ Web 安全组，允许 80/443",\n    "metadata": {\n      "rules": [\n        "tcp/80",\n        "tcp/443"\n      ],\n      "blocked_ips": []\n    }\n  }\n]')
ACTION_DEFINITIONS = json.loads('[\n  {\n    "action": "health_check",\n    "description": "健康检查",\n    "classify": "query",\n    "operation": "health",\n    "parameters": {},\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  },\n  {\n    "action": "query_cloud_assets",\n    "description": "查询云资产",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "ip": {\n        "data_type": "string",\n        "description": "资产 IP",\n        "required": false,\n        "order": 0\n      },\n      "region": {\n        "data_type": "string",\n        "description": "云区域",\n        "required": false,\n        "order": 1\n      }\n    },\n    "filter_keys": [\n      "ip",\n      "metadata.region"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "ip": "10.10.8.23"\n    }\n  },\n  {\n    "action": "query_security_groups",\n    "description": "查询安全组",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "security_group_id": {\n        "data_type": "string",\n        "description": "安全组 ID",\n        "required": false,\n        "order": 0\n      }\n    },\n    "filter_keys": [\n      "id",\n      "metadata.security_group",\n      "security_group_id"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "security_group_id": "sg-dmz-web"\n    }\n  },\n  {\n    "action": "block_ip_in_security_group",\n    "description": "在安全组中封禁 IP",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "security_group_id": {\n        "data_type": "string",\n        "description": "安全组 ID",\n        "required": true,\n        "order": 0\n      },\n      "ip": {\n        "data_type": "string",\n        "description": "需要封禁的 IP",\n        "required": true,\n        "order": 1\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "封禁原因",\n        "required": false,\n        "order": 2,\n        "default_value": "安全处置"\n      }\n    },\n    "filter_keys": [\n      "id",\n      "security_group_id"\n    ],\n    "result_status": "rule_updated",\n    "allow_create": false,\n    "sample": {\n      "security_group_id": "sg-dmz-web",\n      "ip": "203.0.113.77",\n      "reason": "攻击源封禁"\n    }\n  },\n  {\n    "action": "unblock_ip_in_security_group",\n    "description": "从安全组中解除 IP 封禁",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "security_group_id": {\n        "data_type": "string",\n        "description": "安全组 ID",\n        "required": true,\n        "order": 0\n      },\n      "ip": {\n        "data_type": "string",\n        "description": "需要解封的 IP",\n        "required": true,\n        "order": 1\n      }\n    },\n    "filter_keys": [\n      "id",\n      "security_group_id"\n    ],\n    "result_status": "rule_updated",\n    "allow_create": false,\n    "sample": {\n      "security_group_id": "sg-dmz-web",\n      "ip": "203.0.113.77"\n    }\n  },\n  {\n    "action": "create_snapshot",\n    "description": "创建云主机快照",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "instance_id": {\n        "data_type": "string",\n        "description": "云主机 ID",\n        "required": true,\n        "order": 0\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "快照原因",\n        "required": false,\n        "order": 1,\n        "default_value": "应急取证"\n      }\n    },\n    "filter_keys": [\n      "id",\n      "instance_id"\n    ],\n    "result_status": "snapshot_created",\n    "allow_create": false,\n    "sample": {\n      "instance_id": "ecs-prod-web-01",\n      "reason": "应急取证"\n    }\n  },\n  {\n    "action": "query_operation_history",\n    "description": "查询模拟操作历史",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "target": {\n        "data_type": "string",\n        "description": "目标对象，可填写 IP、主机名、用户、工单号等",\n        "required": false,\n        "order": 0\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回结果数量限制",\n        "required": false,\n        "order": 1,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "target"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  }\n]')
...
def query_cloud_assets(params, assets, context_info):
    """查询云资产"""
    return _execute('query_cloud_assets', params, assets, context_info)


def query_security_groups(params, assets, context_info):
    """查询安全组"""
    return _execute('query_security_groups', params, assets, context_info)


def block_ip_in_security_group(params, assets, context_info):
    """在安全组中封禁 IP"""
    return _execute('block_ip_in_security_group', params, assets, context_info)


def unblock_ip_in_security_group(params, assets, context_info):
    """从安全组中解除 IP 封禁"""
    return _execute('unblock_ip_in_security_group', params, assets, context_info)


def create_snapshot(params, assets, context_info):
    """创建云主机快照"""
    return _execute('create_snapshot', params, assets, context_info)
