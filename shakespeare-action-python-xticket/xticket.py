...
def create_ticket(params, assets, context_info):
    """创建工单"""
    return _execute('create_ticket', params, assets, context_info)


def query_ticket(params, assets, context_info):
    """查询工单"""
    return _execute('query_ticket', params, assets, context_info)


def update_ticket_status(params, assets, context_info):
    """更新工单状态"""
    return _execute('update_ticket_status', params, assets, context_info)


def add_ticket_comment(params, assets, context_info):
    """追加工单评论"""
    return _execute('add_ticket_comment', params, assets, context_info)


def assign_ticket(params, assets, context_info):
    """分派工单"""
    return _execute('assign_ticket', params, assets, context_info)


def query_ticket_history(params, assets, context_info):
    """查询工单历史"""
    return _execute('query_ticket_history', params, assets, context_info)
