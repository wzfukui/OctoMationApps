...
def query_endpoint(params, assets, context_info):
    """查询终端防护状态"""
    return _execute('query_endpoint', params, assets, context_info)


def query_threat_events(params, assets, context_info):
    """查询病毒威胁事件"""
    return _execute('query_threat_events', params, assets, context_info)


def start_scan(params, assets, context_info):
    """发起终端扫描任务"""
    return _execute('start_scan', params, assets, context_info)


def quarantine_file(params, assets, context_info):
    """隔离恶意文件"""
    return _execute('quarantine_file', params, assets, context_info)


def remove_threat(params, assets, context_info):
    """清除威胁"""
    return _execute('remove_threat', params, assets, context_info)
