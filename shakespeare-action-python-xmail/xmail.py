...
APP_DESCRIPTION = '离线模拟邮件安全网关，支持邮件解析、事件查询、隔离、释放和发件人阻断'
...
def parse_email(params, assets, context_info):
    """解析邮件内容"""
    return _execute('parse_email', params, assets, context_info)


def query_mail_events(params, assets, context_info):
    """查询邮件安全事件"""
    return _execute('query_mail_events', params, assets, context_info)


def quarantine_message(params, assets, context_info):
    """隔离邮件"""
    return _execute('quarantine_message', params, assets, context_info)


def release_message(params, assets, context_info):
    """释放邮件"""
    return _execute('release_message', params, assets, context_info)


def block_sender(params, assets, context_info):
    """阻断发件人"""
    return _execute('block_sender', params, assets, context_info)
