...
APP_DESCRIPTION = '离线模拟资产与负责人 CMDB，提供资产归属、标签和关联查询能力'
...
ACTION_DEFINITIONS = json.loads('[\n  {\n    "action": "health_check",\n    "description": "健康检查",\n    "classify": "query",\n    "operation": "health",\n    "parameters": {},\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  },\n  {\n    "action": "list_assets",\n    "description": "查询资产列表",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "owner": {\n        "data_type": "string",\n        "description": "负责人账号，可选；内置样例包括 alice、bob、carol",\n        "required": false,\n        "order": 0\n      },\n      "status": {\n        "data_type": "string",\n        "description": "资产状态，可选",\n        "required": false,\n        "order": 1\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回数量",\n        "required": false,\n        "order": 2,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "owner",\n      "status"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "owner": "alice",\n      "limit": 20\n    }\n  },\n  {\n    "action": "query_asset_by_ip",\n    "description": "根据 IP 查询资产负责人信息",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "ip": {\n        "data_type": "string",\n        "description": "资产 IP 地址",\n        "required": true,\n        "order": 0\n      }\n    },\n    "filter_keys": [\n      "ip"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "ip": "10.10.8.23"\n    }\n  },\n  {\n    "action": "query_assets_by_owner",\n    "description": "根据负责人账号查询名下资产",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "owner": {\n        "data_type": "string",\n        "description": "负责人账号；内置样例包括 alice、bob、carol",\n        "required": true,\n        "order": 0,\n        "default_value": "alice"\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回数量",\n        "required": false,\n        "order": 1,\n        "default_value": 20\n      }\n    },\n    "filter_keys": [\n      "owner"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "owner": "alice"\n    }\n  },\n  {\n    "action": "query_asset_relations",\n    "description": "查询资产关联关系",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "asset_id": {\n        "data_type": "string",\n        "description": "资产 ID",\n        "required": true,\n        "order": 0\n      }\n    },\n    "filter_keys": [\n      "id",\n      "asset_id"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "asset_id": "asset-web-01"\n    }\n  },\n  {\n    "action": "query_inventory_summary",\n    "description": "查询资产统计摘要",\n    "classify": "query",\n    "operation": "summary",\n    "parameters": {},\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  },\n  {\n    "action": "update_asset_tag",\n    "description": "更新资产标签",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "asset_id": {\n        "data_type": "string",\n        "description": "资产 ID",\n        "required": true,\n        "order": 0\n      },\n      "tag": {\n        "data_type": "string",\n        "description": "标签名",\n        "required": true,\n        "order": 1\n      },\n      "value": {\n        "data_type": "string",\n        "description": "标签值",\n        "required": true,\n        "order": 2\n      }\n    },\n    "filter_keys": [\n      "id",\n      "asset_id"\n    ],\n    "result_status": "tagged",\n    "allow_create": false,\n    "sample": {\n      "asset_id": "asset-web-01",\n      "tag": "incident",\n      "value": "IR-2026-0001"\n    }\n  },\n  {\n    "action": "create_asset",\n    "description": "新增资产",\n    "classify": "write",\n    "operation": "create",\n    "parameters": {\n      "asset_id": {\n        "data_type": "string",\n        "description": "资产 ID，不填则自动生成",\n        "required": false,\n        "order": 0\n      },\n      "asset_name": {\n        "data_type": "string",\n        "description": "资产名称",\n        "required": true,\n        "order": 1\n      },\n      "ip": {\n        "data_type": "string",\n        "description": "资产 IP 地址",\n        "required": false,\n        "order": 2\n      },\n      "asset_type": {\n        "data_type": "string",\n        "description": "资产类型",\n        "required": false,\n        "order": 3,\n        "default_value": "server"\n      },\n      "owner": {\n        "data_type": "string",\n        "description": "负责人账号",\n        "required": false,\n        "order": 4,\n        "default_value": "secops"\n      },\n      "status": {\n        "data_type": "string",\n        "description": "资产状态",\n        "required": false,\n        "order": 5,\n        "default_value": "online"\n      },\n      "severity": {\n        "data_type": "string",\n        "description": "资产等级",\n        "required": false,\n        "order": 6,\n        "default_value": "medium"\n      },\n      "summary": {\n        "data_type": "string",\n        "description": "资产说明",\n        "required": false,\n        "order": 7,\n        "default_value": "手工新增模拟资产"\n      }\n    },\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "asset_id": "asset-demo-01",\n      "asset_name": "demo-server-01",\n      "ip": "10.30.6.10",\n      "asset_type": "server",\n      "owner": "secops",\n      "status": "online"\n    }\n  },\n  {\n    "action": "update_asset",\n    "description": "更新资产信息",\n    "classify": "write",\n    "operation": "update",\n    "parameters": {\n      "asset_id": {\n        "data_type": "string",\n        "description": "资产 ID",\n        "required": true,\n        "order": 0\n      },\n      "asset_name": {\n        "data_type": "string",\n        "description": "资产名称",\n        "required": false,\n        "order": 1\n      },\n      "ip": {\n        "data_type": "string",\n        "description": "资产 IP 地址",\n        "required": false,\n        "order": 2\n      },\n      "asset_type": {\n        "data_type": "string",\n        "description": "资产类型",\n        "required": false,\n        "order": 3\n      },\n      "owner": {\n        "data_type": "string",\n        "description": "负责人账号",\n        "required": false,\n        "order": 4\n      },\n      "status": {\n        "data_type": "string",\n        "description": "资产状态",\n        "required": false,\n        "order": 5\n      },\n      "severity": {\n        "data_type": "string",\n        "description": "资产等级",\n        "required": false,\n        "order": 6\n      },\n      "summary": {\n        "data_type": "string",\n        "description": "资产说明",\n        "required": false,\n        "order": 7\n      }\n    },\n    "filter_keys": [\n      "id",\n      "asset_id"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "asset_id": "asset-web-01",\n      "owner": "alice",\n      "status": "maintenance"\n    }\n  },\n  {\n    "action": "delete_asset",\n    "description": "删除资产",\n    "classify": "write",\n    "operation": "delete",\n    "parameters": {\n      "asset_id": {\n        "data_type": "string",\n        "description": "资产 ID",\n        "required": true,\n        "order": 0\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "删除原因",\n        "required": false,\n        "order": 1,\n        "default_value": "资产下线"\n      }\n    },\n    "filter_keys": [\n      "id",\n      "asset_id"\n    ],\n    "result_status": "deleted",\n    "allow_create": false,\n    "sample": {\n      "asset_id": "asset-lb-01",\n      "reason": "资产下线"\n    }\n  }\n]')
...
def query_asset_relations(params, assets, context_info):
    """查询资产关联关系"""
    return _execute('query_asset_relations', params, assets, context_info)


def query_inventory_summary(params, assets, context_info):
    """查询资产统计摘要"""
    return _execute('query_inventory_summary', params, assets, context_info)


def update_asset_tag(params, assets, context_info):
    """更新资产标签"""
    return _execute('update_asset_tag', params, assets, context_info)
