...
APP_NAME = 'xjumpserver'
PRODUCT_NAME = 'XJumpServer 堡垒机'
APP_DESCRIPTION = '离线模拟堡垒机访问审计，返回员工通过堡垒机访问目标设备的方式、协议、会话和命令记录'
...
ACTION_DEFINITIONS = json.loads('[\n  {\n    "action": "health_check",\n    "description": "健康检查",\n    "classify": "query",\n    "operation": "health",\n    "parameters": {},\n    "filter_keys": [],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  },\n  {\n    "action": "query_login_records",\n    "description": "查询堡垒机登录记录",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "员工账号",\n        "required": false,\n        "order": 0\n      },\n      "target_ip": {\n        "data_type": "string",\n        "description": "目标设备 IP",\n        "required": false,\n        "order": 1\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回数量",\n        "required": false,\n        "order": 2,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "user",\n      "metadata.target_ip"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "alice",\n      "target_ip": "10.10.8.23"\n    }\n  },\n  {\n    "action": "query_target_access",\n    "description": "查询员工访问目标设备的方式",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "员工账号",\n        "required": false,\n        "order": 0\n      },\n      "target_ip": {\n        "data_type": "string",\n        "description": "目标设备 IP",\n        "required": false,\n        "order": 1\n      }\n    },\n    "filter_keys": [\n      "user",\n      "metadata.target_ip"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "carol",\n      "target_ip": "10.20.4.77"\n    }\n  },\n  {\n    "action": "query_online_sessions",\n    "description": "查询当前在线堡垒机会话",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "username": {\n        "data_type": "string",\n        "description": "员工账号",\n        "required": false,\n        "order": 0\n      },\n      "status": {\n        "data_type": "string",\n        "description": "会话状态",\n        "required": false,\n        "order": 1,\n        "default_value": "online"\n      }\n    },\n    "filter_keys": [\n      "user",\n      "status"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "username": "carol"\n    }\n  },\n  {\n    "action": "query_command_audit",\n    "description": "查询堡垒机命令审计",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "session_id": {\n        "data_type": "string",\n        "description": "会话 ID",\n        "required": true,\n        "order": 0\n      }\n    },\n    "filter_keys": [\n      "metadata.session_id",\n      "session_id"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {\n      "session_id": "sess-jms-0001"\n    }\n  },\n  {\n    "action": "terminate_session",\n    "description": "终止堡垒机会话",\n    "classify": "write",\n    "operation": "write",\n    "parameters": {\n      "session_id": {\n        "data_type": "string",\n        "description": "会话 ID",\n        "required": true,\n        "order": 0\n      },\n      "reason": {\n        "data_type": "string",\n        "description": "终止原因",\n        "required": false,\n        "order": 1,\n        "default_value": "安全处置"\n      }\n    },\n    "filter_keys": [\n      "metadata.session_id",\n      "session_id"\n    ],\n    "result_status": "terminated",\n    "allow_create": false,\n    "sample": {\n      "session_id": "sess-jms-0002",\n      "reason": "可疑远程访问"\n    }\n  },\n  {\n    "action": "query_operation_history",\n    "description": "查询模拟操作历史",\n    "classify": "query",\n    "operation": "query",\n    "parameters": {\n      "target": {\n        "data_type": "string",\n        "description": "目标对象，可填写 IP、主机名、用户、工单号等",\n        "required": false,\n        "order": 0\n      },\n      "limit": {\n        "data_type": "integer",\n        "description": "返回结果数量限制",\n        "required": false,\n        "order": 1,\n        "default_value": 50\n      }\n    },\n    "filter_keys": [\n      "target"\n    ],\n    "result_status": null,\n    "allow_create": false,\n    "sample": {}\n  }\n]')
...
def query_login_records(params, assets, context_info):
    """查询堡垒机登录记录"""
    return _execute('query_login_records', params, assets, context_info)


def query_target_access(params, assets, context_info):
    """查询员工访问目标设备的方式"""
    return _execute('query_target_access', params, assets, context_info)


def query_online_sessions(params, assets, context_info):
    """查询当前在线堡垒机会话"""
    return _execute('query_online_sessions', params, assets, context_info)


def query_command_audit(params, assets, context_info):
    """查询堡垒机命令审计"""
    return _execute('query_command_audit', params, assets, context_info)


def terminate_session(params, assets, context_info):
    """终止堡垒机会话"""
    return _execute('terminate_session', params, assets, context_info)
