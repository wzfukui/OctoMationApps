...
def query_host_by_ip(params, assets, context_info):
    """根据 IP 查询主机信息"""
    return _execute('query_host_by_ip', params, assets, context_info)


def query_host_processes(params, assets, context_info):
    """查询主机进程信息"""
    return _execute('query_host_processes', params, assets, context_info)


def query_host_ports(params, assets, context_info):
    """查询主机端口信息"""
    return _execute('query_host_ports', params, assets, context_info)


def query_security_events(params, assets, context_info):
    """查询主机安全事件"""
    return _execute('query_security_events', params, assets, context_info)


def isolate_host(params, assets, context_info):
    """隔离主机"""
    return _execute('isolate_host', params, assets, context_info)


def release_host(params, assets, context_info):
    """解除主机隔离"""
    return _execute('release_host', params, assets, context_info)
