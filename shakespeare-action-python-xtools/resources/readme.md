...
### parse_text_to_urls（文本_解析URL列表）

#### 入参

| 参数名 | 参数描述 | 参数类型 | 是否必填 | 默认值 |
|--------|----------|----------|----------|--------|
| text | 待解析的文本内容 | string | 是 | |

#### 出参

| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.urls.* | 解析出的URL列表 | string | |
| action_result.data.urls | 解析出的URL列表 | jsonArray | |

### parse_text_to_domains（文本_解析域名列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.domains.* | 解析出的域名列表 | string | |
| action_result.data.domains | 解析出的域名列表 | jsonArray | |

### parse_text_to_ipv4s（文本_解析IPv4列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.ipv4s.* | 解析出的IPv4列表 | string | |
| action_result.data.ipv4s | 解析出的IPv4列表 | jsonArray | |

### parse_text_to_ipv6s（文本_解析IPv6列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.ipv6s.* | 解析出的IPv6列表 | string | |
| action_result.data.ipv6s | 解析出的IPv6列表 | jsonArray | |

### parse_text_to_emails（文本_解析Email列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.emails.* | 解析出的Email列表 | string | |
| action_result.data.emails | 解析出的Email列表 | jsonArray | |

### parse_text_to_md5s（文本_解析MD5列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.md5s.* | 解析出的MD5列表 | string | 32位十六进制字符串 |
| action_result.data.md5s | 解析出的MD5列表 | jsonArray | 32位十六进制字符串 |

### parse_text_to_sha128s（文本_解析SHA128列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.sha128s.* | 解析出的SHA128列表 | string | 32位十六进制字符串，与MD5文本形态一致 |
| action_result.data.sha128s | 解析出的SHA128列表 | jsonArray | 32位十六进制字符串，与MD5文本形态一致 |

### parse_text_to_sha256s（文本_解析SHA256列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.sha256s.* | 解析出的SHA256列表 | string | 64位十六进制字符串 |
| action_result.data.sha256s | 解析出的SHA256列表 | jsonArray | 64位十六进制字符串 |

### parse_text_to_macs（文本_解析MAC地址列表）
...
| 参数名 | 参数描述 | 参数类型 | 备注 |
|--------|----------|----------|------|
| action_result.data.macs.* | 解析出的MAC地址列表 | string | 支持冒号、短横线、Cisco点分格式 |
| action_result.data.macs | 解析出的MAC地址列表 | jsonArray | 支持冒号、短横线、Cisco点分格式 |
...
## 更新说明
- 2026-06-25 v2.0.7 增加文本解析动作：URL、域名、IPv4、IPv6、Email、MD5、SHA128、SHA256、MAC
