...
def add_scan_target(params, assets, context_info):
    """新增扫描目标"""
    return _execute('add_scan_target', params, assets, context_info)
...
def query_scan_status(params, assets, context_info):
    """查询扫描状态"""
    return _execute('query_scan_status', params, assets, context_info)


def query_vulnerabilities(params, assets, context_info):
    """查询漏洞结果"""
    return _execute('query_vulnerabilities', params, assets, context_info)


def generate_report(params, assets, context_info):
    """生成扫描报告"""
    return _execute('generate_report', params, assets, context_info)
