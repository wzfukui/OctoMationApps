...
def submit_file(params, assets, context_info):
    """提交文件样本"""
    return _execute('submit_file', params, assets, context_info)


def submit_url(params, assets, context_info):
    """提交 URL 样本"""
    return _execute('submit_url', params, assets, context_info)


def query_analysis_report(params, assets, context_info):
    """查询分析报告"""
    return _execute('query_analysis_report', params, assets, context_info)


def query_behavior_trace(params, assets, context_info):
    """查询行为轨迹"""
    return _execute('query_behavior_trace', params, assets, context_info)
